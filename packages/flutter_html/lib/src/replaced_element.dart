...
class VideoContentElement extends ReplacedElement {
  ...
  final double? width;
  final double? height;
  final VideoPlayerController Function(String? src)? playerController;
      ...
      child: Container(
        ...
        child: Chewie(
          controller: ChewieController(
            ...
            videoPlayerController: playerController != null ? playerController!(src.first ?? "") : VideoPlayerController.network(
              src.first ?? "",
            ),
...
ReplacedElement parseReplacedElement(
  ...
  VideoPlayerController Function(String? src)? playerController,
) {
